...
import { appendQueryParamsToURL, getCurrentNormalisedUrlPathWithQueryParamsAndFragments, getTenantIdFromQueryParams, getNormalisedUserContext, normaliseInputAppInfoOrThrowError, normaliseCookieScopeOrThrowError, getDefaultCookieScope, appendTrailingSlashToURL, isTest, getOriginOfPage, redirectWithFullPageReload, redirectWithNavigate } from './utils.js';
...
var SuperTokens = /** @class */ (function () {
    ...
    SuperTokens.init = function (config) {
        ...
        SuperTokensWebJS.init(__assign(__assign({}, config), { recipeList: recipes.map(function (_a) {
                var webJS = _a.webJS;
                return webJS;
            }) }));
