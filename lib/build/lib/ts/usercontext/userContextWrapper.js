...
import { UserContextProvider, UserContextContext } from "./index.js";
...
function UserContextWrapper(props) {
    ...
    if (props.userContext !== undefined) {
        return jsx(UserContextProvider, __assign({ userContext: props.userContext }, { children: props.children }));
    }
    return jsx(UserContextContext.Consumer, {
        children: function (value) {
             ...
             */
            if (value === undefined) {
                return jsx(UserContextProvider, { children: props.children });
            }
            /**
...
export { UserContextWrapper as default };
