...
var OAuth2LogoutScreen = function (props) {
    ...
    var _d = React.useState(false), isLoggingOut = _d[0], setIsLoggingOut = _d[1];
    ...
    var navigate = (_b = props.navigate) !== null && _b !== void 0 ? _b : (_c = UI.getReactRouterDomWithCustomHistory()) === null || _c === void 0 ? void 0 : _c.useHistoryCustom();
    var onLogout = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 6]);
                    return [4 /*yield*/, OAuth2Provider.getInstanceOrThrow().webJSRecipe.logOut({
    ...
    return (jsx(ComponentOverrideContext.Provider, __assign({ value: recipeComponentOverrides }, { children: jsx(FeatureWrapper, __assign({ useShadowDom: SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxs(Fragment, { children: [props.children === undefined && jsx(OAuth2LogoutScreenTheme, __assign({}, childProps)), props.children &&
