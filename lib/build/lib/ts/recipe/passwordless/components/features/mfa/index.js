    ...
    return jsxs(Fragment, {
        children: [
            props.children === undefined &&
                jsx(MFAThemeWrapper, __assign({}, childProps, { featureState: state, dispatch: dispatch })),
            props.children &&
            ...
            { value: recipeComponentOverrides },
            {
                children: jsx(
                    ...
                    __assign(
                        ...
                        { children: jsx(MFAFeatureInner, __assign({}, props)) }
                    )
                ),
            }
        )
                    ...
                    switch (_c.label) {
                        ...
                        case 8:
                            ...
                            return [
                                ...
                                recipeImplementation.createCode(
                                    __assign(__assign({}, createCodeInfo), {
                        ...
                        case 10:
                            ...
                            if (
                                !(
                                    "status" in err_1 &&
                                    err_1.status === Session.getInstanceOrThrow().config.invalidClaimStatusCode
                                )
                            )
                                return [3 /*break*/, 15];
                            return [
                                4 /*yield*/,
                                getInvalidClaimsFromResponse({ response: err_1, userContext: userContext }),
                            ];
                        case 11:
                        ...
                        case 0:
                            return [
                                ...
                                originalImpl.consumeCode(
                                    __assign(__assign({}, input), { shouldTryLinkingWithSessionUser: true })
                                ),
                            ];
                        case 1:
                            res = _a.sent();
