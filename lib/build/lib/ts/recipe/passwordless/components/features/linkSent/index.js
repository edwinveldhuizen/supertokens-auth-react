...
import { useRethrowInRender, getTenantIdFromQueryParams, getRedirectToPathFromURL, clearErrorQueryParam } from '../../../../../utils.js';
...
import LinkSentWrapper from '../../themes/linkSent/index.js';
...
function useChildProps(recipe, loginAttemptInfo, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    ...
    var recipeImplementation = React.useMemo(function () { return getModifiedRecipeImplementation(recipe.webJSRecipe, onError, rebuildAuthPage); }, [recipe, onError, rebuildAuthPage]);
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/, Session.getInstanceOrThrow()
                            ...
                            }, recipe.recipeID, getRedirectToPathFromURL(), userContext, navigate)
...
var LinkSentFeatureInner = function (props) {
    var childProps = useChildProps(props.recipe, props.loginAttemptInfo, props.error, props.onError, props.clearError, props.rebuildAuthPage, props.userContext, props.navigate);
    return (jsxs(Fragment, { children: [props.children === undefined && jsx(LinkSentWrapper, __assign({}, childProps, { userContext: props.userContext })), props.children &&
...
var LinkSentFeature = function (props) {
    ...
    return (jsx(AuthComponentWrapper, __assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsx(LinkSentFeatureInner, __assign({}, props)) })));
};
function getModifiedRecipeImplementation(originalImpl, setError, rebuildAuthPage) {
    var _this = this;
    return __assign(__assign({}, originalImpl), { resendCode: function (input) { return __awaiter(_this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, originalImpl.setLoginAttemptInfo({
                                userContext: input.userContext,
                                attemptInfo: __assign(__assign({}, loginAttemptInfo), { shouldTryLinkingWithSessionUser: (_a = loginAttemptInfo.shouldTryLinkingWithSessionUser) !== null && _a !== void 0 ? _a : false, lastResend: timestamp }),
                            })];
                    case 3:
                        _b.sent();
                        _b.label = 4;
...
export { LinkSentFeature, LinkSentFeature as default, useChildProps };
