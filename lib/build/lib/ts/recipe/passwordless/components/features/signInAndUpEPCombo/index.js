...
import { useRethrowInRender, validateForm, getTenantIdFromQueryParams, getRedirectToPathFromURL } from '../../../../../utils.js';
...
function useChildProps(recipe, factorIds, onAuthSuccess, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    ...
    var _a = React.useState(!recipe.config.signInUpFeature.defaultToEmail), isPhoneNumber = _a[0], setIsPhoneNumber = _a[1];
    var _b = React.useState(false), showPasswordField = _b[0], setShowPasswordField = _b[1];
    var _c = React.useState(false), showContinueWithPasswordlessLink = _c[0], setShowContinueWithPasswordlessLink = _c[1];
    ...
    return useMemo(function () {
        ...
        return {
            ...
            onContactInfoSubmit: function (contactInfo) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, Promise.all([
                                    EmailPassword.getInstanceOrThrow().webJSRecipe.doesEmailExist({ email: email, userContext: userContext }),
            ...
            onPasswordSubmit: function (formFields) { return __awaiter(_this, void 0, void 0, function () {
                var validationErrors, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, validateForm(formFields, EmailPassword.getInstanceOrThrow().config.signInAndUpFeature.signInForm.formFields)];
                        case 1:
                            ...
                            return [4 /*yield*/, EmailPassword.getInstanceOrThrow().webJSRecipe.signIn({
                        ...
                        case 2:
                            ...
                            if (response.status === "WRONG_CREDENTIALS_ERROR") {
                                ...
                                return [2 /*return*/, __assign(__assign({}, response), { isEmailPassword: true })];
                            }
                    }
                });
            }); },
            onContinueWithPasswordlessClick: function (contactInfo) { return __awaiter(_this, void 0, void 0, function () {
                var createInfo, createRes;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            createInfo = isPhoneNumber ? { phoneNumber: contactInfo } : { email: contactInfo };
                            return [4 /*yield*/, recipeImplementation.createCode(__assign(__assign({}, createInfo), { shouldTryLinkingWithSessionUser: false, userContext: userContext }))];
                        case 1:
                            createRes = _a.sent();
...
var SignInUpEPComboFeature = function (props) {
    ...
    return (jsx(AuthComponentWrapper, __assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsx(SignInUpEPComboFeatureInner, __assign({}, props)) })));
};
