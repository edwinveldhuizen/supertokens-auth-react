...
var LinkClickedScreen = function (props) {
    ...
    var consumeCodeAtMount = useCallback(
        function () {
    ...
    var handleConsumeResp = useCallback(
        function (consumeRes) {
            return __awaiter(void 0, void 0, void 0, function () {
    ...
    var handleConsumeError = useCallback(
        function (err) {
                    ...
                    __assign(
                        ...
                        },
                        {
                            children: jsxs(Fragment, {
                                children: [
                                    props.children === undefined && jsx(LinkClickedScreen$1, __assign({}, childProps)),
                                    props.children &&
