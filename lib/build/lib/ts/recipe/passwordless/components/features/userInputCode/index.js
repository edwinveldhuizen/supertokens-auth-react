...
var UserInputCodeFeatureInner = function (props) {
    ...
    return (jsxs(Fragment, { children: [props.children === undefined && (jsx(UserInputCodeFormScreenWrapper, __assign({}, childProps, { userContext: props.userContext }))), props.children &&
...
var UserInputCodeFeature = function (props) {
    ...
    return (jsx(AuthComponentWrapper, __assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsx(UserInputCodeFeatureInner, __assign({}, props)) })));
};
