...
var SignInUpTheme = function (_a) {
    ...
    return activeScreen === SignInUpScreens.EmailForm
        ? jsx(EmailForm, __assign({}, commonProps))
        : activeScreen === SignInUpScreens.PhoneForm
        ? jsx(PhoneForm, __assign({}, commonProps))
        : activeScreen === SignInUpScreens.EmailOrPhoneForm
        ? jsx(EmailOrPhoneForm, __assign({}, commonProps))
        : null;
};
            ...
            { userContext: props.userContext },
            {
                children: jsx(
                    ...
                    __assign(
                        ...
                        { children: jsx(SignInUpTheme, __assign({}, props, { activeScreen: activeScreen })) }
                    )
                ),
            }
        )
