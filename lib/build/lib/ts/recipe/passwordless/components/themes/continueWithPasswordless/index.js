...
var ContinueWithPasswordless = function (props) {
    return (jsx("div", __assign({ "data-supertokens": "continueWithPasswordlessButtonWrapper" }, { children: jsx(Button, { isLoading: false, onClick: function () {
                props.continueWithPasswordlessClicked();
            }, type: "button", label: "PWLESS_COMBO_CONTINUE_WITH_PASSWORDLESS_BUTTON" }) })));
};
var ContinueWithPasswordlessWithOverride = withOverride("PasswordlessContinueWithPasswordless", ContinueWithPasswordless);
var ContinueWithPasswordlessTheme = function (props) {
    var rootStyle = SuperTokens.getInstanceOrThrow().rootStyle;
    return (jsx(ThemeBase, __assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsx(ContinueWithPasswordlessWithOverride, __assign({}, props)) })));
};
