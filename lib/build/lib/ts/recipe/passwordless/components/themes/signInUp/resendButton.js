...
var ResendButton = withOverride("PasswordlessResendButton", function PasswordlessResendButton(_a) {
    ...
    var _b = useState(getTimeLeft()), secsUntilResend = _b[0], setSecsUntilResend = _b[1];
    useEffect(function () {
    ...
    return (jsx("button", __assign({ type: "button", disabled: secsUntilResend !== undefined, onClick: onClick, "data-supertokens": "link linkButton formLabelLinkBtn resendCodeBtn" }, { children: secsUntilResend !== undefined ? (jsxs(React__default.Fragment, { children: [t("PWLESS_RESEND_BTN_DISABLED_START"), jsxs("strong", { children: [Math.floor(secsUntilResend / 60)
                            .toString()
