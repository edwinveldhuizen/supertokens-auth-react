...
var PasswordlessLinkSent = function (props) {
    ...
    var _a = useState(props.error !== undefined ? "ERROR" : "READY"),
        status = _a[0],
        setStatus = _a[1];
                                    ...
                                    __assign(
                                        { "data-supertokens": "primaryText sendCodeText" },
                                        {
                                            children: [
                                                ...
                                                jsx("strong", { children: props.loginAttemptInfo.contactInfo }),
                                                props.loginAttemptInfo.contactMethod === "EMAIL"
            ...
            { userContext: props.userContext },
            {
                children: jsx(
                    ...
                    __assign(
                        ...
                        { children: jsx(LinkSent, __assign({}, props)) }
                    )
                ),
            }
        )
