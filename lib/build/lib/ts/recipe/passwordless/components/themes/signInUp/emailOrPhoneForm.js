...
var EmailOrPhoneForm = withOverride("PasswordlessEmailOrPhoneForm", function PasswordlessEmailOrPhoneForm(props) {
    ...
    var _a = useState(!props.config.signInUpFeature.defaultToEmail), isPhoneNumber = _a[0], setIsPhoneNumber = _a[1];
    ...
    return (jsx(FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: isPhoneNumber
            ? [
                {
                    id: "phoneNumber",
                    label: "",
                    labelComponent: (jsxs("div", __assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsx(Label, { value: "PWLESS_SIGN_IN_UP_PHONE_LABEL" }), jsx("a", __assign({ onClick: function () { return setIsPhoneNumber(false); }, "data-supertokens": "link linkButton formLabelLinkBtn contactMethodSwitcher" }, { children: t("PWLESS_SIGN_IN_UP_SWITCH_TO_EMAIL") }))] }))),
            ...
            : [
                {
                    id: "email",
                    label: "",
                    labelComponent: (jsxs("div", __assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsx(Label, { value: "PWLESS_SIGN_IN_UP_EMAIL_LABEL", "data-supertokens": "passwordInputLabel" }), jsx("a", __assign({ onClick: function () { return setIsPhoneNumber(function (v) { return !v; }); }, "data-supertokens": "link linkButton formLabelLinkBtn contactMethodSwitcher" }, { children: t("PWLESS_SIGN_IN_UP_SWITCH_TO_PHONE") }))] }))),
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        _c.label = 4;
                    case 4: return [4 /*yield*/, props.recipeImplementation.createCode(__assign(__assign({}, contactInfo), { 
