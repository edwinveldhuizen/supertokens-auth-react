...
var UserInputCodeFormScreen = function (props) {
    return (jsxs("div", __assign({ "data-supertokens": "container" }, { children: [jsxs("div", __assign({ "data-supertokens": "row" }, { children: [jsx(UserInputCodeFormHeader, __assign({}, props)), props.error !== undefined && jsx(GeneralError, { error: props.error }), jsx(UserInputCodeForm, __assign({}, props))] })), jsx(SuperTokensBranding, {})] })));
};
var UserInputCodeForm = withOverride("PasswordlessUserInputCodeForm", function (props) {
    ...
    var _b = useState(), clearResendNotifTimeout = _b[0], setClearResendNotifTimeout = _b[1];
    useEffect(function () {
    ...
    var resend = useCallback(function resend() {
    ...
    return (jsxs(Fragment, { children: [clearResendNotifTimeout !== undefined && (jsx("div", __assign({ "data-supertokens": "generalSuccess" }, { children: props.loginAttemptInfo.contactMethod === "EMAIL"
                    ? t("PWLESS_RESEND_SUCCESS_EMAIL")
                    : t("PWLESS_RESEND_SUCCESS_PHONE") }))), jsx(FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: [
                    {
                        id: "userInputCode",
                        label: "",
                        labelComponent: (jsxs("div", __assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsx(Label, { value: "PWLESS_USER_INPUT_CODE_INPUT_LABEL", "data-supertokens": "codeInputLabel" }), jsx(ResendButton, { loginAttemptInfo: props.loginAttemptInfo, resendEmailOrSMSGapInSeconds: props.config.signInUpFeature.resendEmailOrSMSGapInSeconds, onClick: resend })] }))),
                        autofocus: true,
                        optional: false,
                        clearOnSubmit: true,
                ...
                ], onSuccess: props.onSuccess, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", callAPI: function (formFields) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                }); }, validateOnBlur: false, showLabels: true, footer: (_a = props.footer) !== null && _a !== void 0 ? _a : jsx(UserInputCodeFormFooter, __assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })) })] }));
});
function UserInputCodeFormScreenWrapper(props) {
    ...
    return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(ThemeBase, __assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsx(UserInputCodeFormScreen, __assign({}, props)) })) })));
}
