...
var EPComboEmailOrPhoneForm = withOverride("PasswordlessEPComboEmailOrPhoneForm", function PasswordlessEPComboEmailOrPhoneForm(props) {
    var _this = this;
    ...
    var phoneInput = useMemo(function () {
        ...
        : [
            {
                id: "email",
                label: "",
                labelComponent: (jsxs("div", __assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsx(Label, { value: "PWLESS_SIGN_IN_UP_EMAIL_LABEL" }), jsx("a", __assign({ onClick: function () { return props.setIsPhoneNumber(true); }, "data-supertokens": "link linkButton formLabelLinkBtn contactMethodSwitcher" }, { children: t("PWLESS_SIGN_IN_UP_SWITCH_TO_PHONE") }))] }))),
    ...
    return (jsx(FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: formFields, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", callAPI: function (formFields) { return __awaiter(_this, void 0, void 0, function () {
        ...
        }); }, validateOnBlur: false, showLabels: true, onSuccess: props.onSuccess, footer: props.showContinueWithPasswordlessLink ? (jsx(ContinueWithPasswordlessFooter, { isPhoneNumber: props.isPhoneNumber, onContinueWithPasswordlessClick: props.onContinueWithPasswordlessClick, validatePhoneNumber: props.validatePhoneNumber, onError: props.onError, config: props.config })) : undefined }));
});
