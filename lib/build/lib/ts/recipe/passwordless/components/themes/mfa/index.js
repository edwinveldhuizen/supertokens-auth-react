...
var MFATheme = function (_a) {
    var activeScreen = _a.activeScreen, featureState = _a.featureState, onBackButtonClicked = _a.onBackButtonClicked, props = __rest(_a, ["activeScreen", "featureState", "onBackButtonClicked"]);
    ...
    return activeScreen === MFAScreens.AccessDenied ? (jsx(AccessDeniedScreen, { useShadowDom: false /* We set this to false, because we are already inside a shadowDom (if required) */, error: t(featureState.error) })) : (jsxs("div", __assign({ "data-supertokens": "container pwless-mfa" }, { children: [jsx("div", __assign({ "data-supertokens": "row" }, { children: jsxs(React__default.Fragment, { children: [activeScreen === MFAScreens.UserInputCodeForm ? (jsx(MFAOTPHeader, __assign({}, commonProps, { showBackButton: featureState.showBackButton, loginAttemptInfo: featureState.loginAttemptInfo, canChangeEmail: featureState.canChangeEmail, onBackButtonClicked: onBackButtonClicked }))) : (jsx(MFAHeader, __assign({}, commonProps, { showBackButton: featureState.showBackButton, onBackButtonClicked: onBackButtonClicked, contactMethod: activeScreen === MFAScreens.EmailForm ? "EMAIL" : "PHONE" }))), featureState.error !== undefined && jsx(GeneralError, { error: featureState.error }), activeScreen === MFAScreens.EmailForm ? (jsx(EmailForm, __assign({}, commonProps, { footer: jsx(MFAFooter, __assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail })) }))) : activeScreen === MFAScreens.PhoneForm ? (jsx(PhoneForm, __assign({}, commonProps, { footer: jsx(MFAFooter, __assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail })) }))) : activeScreen === MFAScreens.UserInputCodeForm ? (jsx(UserInputCodeForm, __assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo, onSuccess: props.onSuccess, footer: jsx(MFAOTPFooter, __assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail, loginAttemptInfo: featureState.loginAttemptInfo })) }))) : null] }) })), jsx(SuperTokensBranding, {})] })));
};
function MFAThemeWrapper(props) {
    ...
    return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(ThemeBase, __assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle, props.config.mfaFeature.style] }, { children: jsx(MFATheme, __assign({}, props, { activeScreen: activeScreen })) })) })));
}
