...
var Webauthn = /** @class */ (function (_super) {
    ...
    function Webauthn(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = WebauthnWebJS; }
        ...
        _this.getDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (context.action === "SEND_RECOVERY_EMAIL") {
                    return [2 /*return*/, getDefaultRedirectionURLForPath(this.config, DEFAULT_WEBAUTHN_SEND_RECOVERY_EMAIL_PATH, context)];
                }
    ...
    Webauthn.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Webauthn.instance = new Webauthn(__assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Webauthn.RECIPE_ID }));
                return Webauthn.instance;
            },
            webJS: WebauthnWebJS.init(__assign(__assign({}, normalisedConfig), { override: {
