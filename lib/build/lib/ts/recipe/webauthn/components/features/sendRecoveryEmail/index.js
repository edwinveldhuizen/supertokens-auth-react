...
var SendRecoveryEmailForm = function (props) {
    ...
    var _c = React.useState(SendRecoveryEmailScreen.RecoverAccount),
        activeScreen = _c[0],
    ...
    var onRecoverAccountBackClick = function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, redirectToAuth({ show: "signup" })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                            ...
                            children: jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsx(SendRecoveryEmailFormTheme, __assign({}, childProps)),
                                    props.children &&
