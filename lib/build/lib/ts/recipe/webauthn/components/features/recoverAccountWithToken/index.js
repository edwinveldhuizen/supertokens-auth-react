...
var RecoverAccountUsingToken = function (props) {
    ...
    var _b = useState(null), errorMessageLabel = _b[0], setErrorMessageLabel = _b[1];
    var _c = useState(null), preloadedRegisterOptions = _c[0], setPreloadedRegisterOptions = _c[1];
    var _d = useState(RecoverAccountScreen.ContinueWithPasskey), activeScreen = _d[0], setActiveScreen = _d[1];
    ...
    // with the options.
    var fetchAndStoreRegisterOptions = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    useOnMountAPICall(fetchAndStoreRegisterOptions, function (registerOptions) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    var callAPI = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, props.recipe.webJSRecipe.registerCredential({
    ...
    var onContinueClick = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
