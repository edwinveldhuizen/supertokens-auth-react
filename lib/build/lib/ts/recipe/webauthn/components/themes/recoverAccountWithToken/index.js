...
function PasskeyRecoverAccountWithTokenTheme(props) {
    ...
    var _a = useState(false), isPasskeySupported = _a[0], setIsPasskeySupported = _a[1];
    useEffect(function () {
    ...
    return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(ThemeBase, __assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxs("div", __assign({ "data-supertokens": "container authPage singleFactor" }, { children: [jsxs("div", __assign({ "data-supertokens": "row" }, { children: [props.activeScreen !== RecoverAccountScreen.Success && (jsx(AuthPageHeader, { factorIds: ["webauthn"], isSignUp: true, onSignInUpSwitcherClick: undefined, hasSeparateSignUpView: true, resetFactorList: onResetFactorList, showBackButton: false, oauth2ClientInfo: undefined, headerLabel: props.activeScreen === RecoverAccountScreen.ContinueWithPasskey
                                    ? "WEBAUTHN_CREATE_A_PASSKEY_HEADER"
                                    : undefined, hideSignInSwitcher: true })), renderInnerContent(), props.activeScreen !== RecoverAccountScreen.Success && (jsx(AuthPageFooter, { factorIds: [], isSignUp: true, hasSeparateSignUpView: true, privacyPolicyLink: privacyPolicyLink, termsOfServiceLink: termsOfServiceLink }))] })), jsx(SuperTokensBranding, {})] })) })) })));
}
