...
var SignUpFormInner = withOverride("WebauthnPasskeySignUpForm", function PasskeyEmailForm(props) {
    ...
    var defaultFooter = props.resetFactorList !== undefined && props.showBackButton ? (jsx(ContinueWithoutPasskey, { onClick: props.resetFactorList })) : undefined;
    var onEmailContinueSuccess = useCallback(function (params) {
    ...
    return (jsxs("div", __assign({ "data-supertokens": "signUpFormInnerContainer" }, { children: [jsx("div", __assign({ "data-supertokens": "cautionMessage" }, { children: t("WEBAUTHN_SIGN_UP_CAUTION_MESSAGE_LABEL") })), jsx(FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: onError, formFields: [
                    {
                        id: "email",
                        label: "",
                        labelComponent: (jsxs("div", __assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsx(Label, { value: "WEBAUTHN_SIGN_UP_LABEL", "data-supertokens": "emailInputLabel" }), jsx("a", __assign({ onClick: props.onRecoverAccountClick, "data-supertokens": "link linkButton formLabelLinkBtn recoverAccountTrigger" }, { children: t("WEBAUTHN_RECOVER_ACCOUNT_LABEL") }))] }))),
                        optional: false,
                        autofocus: true,
                        placeholder: "",
                        autoComplete: "email",
                ...
                ], buttonLabel: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", onSuccess: onEmailContinueSuccess, callAPI: function (formFields) { return __awaiter(_this, void 0, void 0, function () {
                    var email;
                    var _a;
...
var SignUpForm = function (props) {
    var _a = useState(null), continueClickResponse = _a[0], setContinueClickResponse = _a[1];
    var userContext = useUserContext();
    var _b = useState(undefined), errorLabel = _b[0], setErrorLabel = _b[1];
    var _c = useState(false), isLoading = _c[0], setIsLoading = _c[1];
    var _d = useState(false), isPasskeySupported = _d[0], setIsPasskeySupported = _d[1];
    useEffect(function () {
    ...
    var onContinueClickCallback = useCallback(function (params) {
        setContinueClickResponse(params);
        props.onContinueClick(params);
    }, [setContinueClickResponse, props]);
    var callAPI = useCallback(function (_, __) { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var onConfirmationClick = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return props.activeScreen === SignUpScreen.SignUpForm ? (jsx(SignUpFormInner, __assign({}, props, { onContinueClick: onContinueClickCallback }))) : props.activeScreen === SignUpScreen.PasskeyConfirmation ? (jsx(PasskeyConfirmation, __assign({}, props, { email: (continueClickResponse === null || continueClickResponse === void 0 ? void 0 : continueClickResponse.email) || "", onContinueClick: onConfirmationClick, errorMessageLabel: errorLabel, isLoading: isLoading, isPasskeySupported: isPasskeySupported }))) : props.activeScreen === SignUpScreen.Error ? (jsx(SignUpSomethingWentWrong, { onClick: function () { return props.setActiveScreen(SignUpScreen.SignUpForm); } })) : null;
};
