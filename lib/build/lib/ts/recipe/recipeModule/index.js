...
import { appendQueryParamsToURL, getNormalisedUserContext } from '../../utils.js';
import { BaseRecipeModule } from './baseRecipeModule.js';
...
var RecipeModule = /** @class */ (function (_super) {
    __extends(RecipeModule, _super);
    function RecipeModule() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.redirect = function (context, navigate, queryParams, userContext) { return __awaiter(_this, void 0, void 0, function () {
            var redirectUrl;
        ...
        _this.getRedirectUrl = function (context, userContext) { return __awaiter(_this, void 0, void 0, function () {
            var redirectUrl;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
export { RecipeModule as default };
