                        ...
                        { requireAuth: false, doRedirection: false },
                        {
                            children: jsx(
                                ...
                                __assign(
                                    ...
                                    { children: jsx(AuthPageInner, __assign({}, props)) }
                                )
                            ),
                        }
                    )
...
var AuthPageInner = function (props) {
    ...
    var onSignInUpSwitcherClick = useCallback(
        function () {
    ...
    var childProps =
        ...
        (loginChallenge === null || oauth2ClientInfo !== undefined || OAuth2Provider.getInstance() === undefined)
            ? __assign(__assign({}, authComponentListInfo), {
            ...
            : undefined;
    var mergedTranslations = useMemo(
        function () {
                                            ...
                                            children: jsxs(Fragment, {
                                                children: [
                                                    props.children === undefined &&
                                                        jsx(AuthPageThemeWrapper, __assign({}, childProps)),
                                                    props.children &&
...
function buildAndSetChildProps(
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    authRecipesInited = SuperTokens.getInstanceOrThrow().recipeList.filter(function (recipe) {
                    ...
                    firstFactors =
                        (_c =
                            (_a =
                                ...
                                ? _a
                                : (_b = MultiFactorAuth.getInstance()) === null || _b === void 0
                                ? void 0
                    ...
                    if (
                        ...
                        ((_d = MultiFactorAuth.getInstance()) === null || _d === void 0
                            ? void 0
                    ...
                    if (firstFactors.includes(FactorIds.THIRDPARTY)) {
                        thirdPartyPreBuiltUI = recipeRouters.find(function (r) {
                            return r.recipeInstance.recipeID === FactorIds.THIRDPARTY;
                        });
                    ...
                    if (selectedComponents === undefined) {
                        ...
                        source =
                            factorListState !== undefined
                                ...
                                : ((_e = MultiFactorAuth.getInstance()) === null || _e === void 0
                                      ? void 0
