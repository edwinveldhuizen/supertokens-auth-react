...
var SessionAuth = function (_a) {
    ...
    var _c = useState({ loading: true }),
        context = _c[0],
        setContext = _c[1];
    var setContextIfChanged = useCallback(
        function (newValue) {
    ...
    var setInitialContextAndMaybeRedirect = useCallback(
                        ...
                        case 7:
                            if (
                                ...
                                return [
                                    2 /*return*/,
                                    setContextIfChanged(
                                        __assign(__assign({}, toSetContext), {
    ...
    if (!context.loading && context.accessDeniedValidatorError && props.accessDeniedScreen) {
        return jsx(props.accessDeniedScreen, {
            userContext: userContext,
            navigate: navigate,
...
var SessionAuthWrapper = function (props) {
    return jsx(
        UserContextWrapper,
        __assign({ userContext: props.userContext }, { children: jsx(SessionAuth, __assign({}, props)) })
    );
};
