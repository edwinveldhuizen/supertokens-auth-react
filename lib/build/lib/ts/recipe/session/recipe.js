...
import { isTest, getTenantIdFromQueryParams, removeFromLocalStorage, getLocalStorage, setLocalStorage, getNormalisedUserContext } from '../../utils.js';
import OAuth2Provider from '../oauth2provider/recipe.js';
import RecipeModule from '../recipeModule/index.js';
import { normaliseSessionConfig, validateAndCompareOnFailureRedirectionURLToCurrent, getFailureRedirectionInfo } from './utils.js';
...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = WebJSSessionRecipe; }
        ...
        successRedirectContext, fallbackRecipeId, redirectToPath, userContext, navigate) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, setLocalStorage("supertokens-success-redirection-context", jsonContext)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    ...
                    case 5:
                        ...
                        if (failureRedirectInfo.redirectPath !== undefined) {
                            ...
                            return [2 /*return*/, SuperTokens.getInstanceOrThrow().redirectToUrl(failureRedirectInfo.redirectPath, navigate)];
                        }
                        _a.label = 6;
                    case 6:
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, removeFromLocalStorage("supertokens-success-redirection-context")];
                    case 10:
                        _a.sent();
                        return [7 /*endfinally*/];
                    ...
                    case 13:
                        ...
                        if (successRedirectContext.action === "SUCCESS_OAUTH2") {
                            return [2 /*return*/, OAuth2Provider.getInstanceOrThrow().redirect(successRedirectContext, navigate, {}, userContext)];
                        }
                        if (successRedirectContext.action === "SUCCESS" && redirectToPath !== undefined) {
                            successRedirectContext.redirectToPath = redirectToPath;
                        }
                        return [2 /*return*/, SuperTokens.getInstanceOrThrow().redirect(successRedirectContext, navigate, {}, userContext)];
                }
            });
        }); };
        /**
         ...
         * @returns "/"
         */
        _this.getDefaultRedirectionURL = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Session.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Session.instance = new Session(__assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Session.RECIPE_ID }));
                return Session.instance;
            },
            webJS: WebJSSessionRecipe.init(__assign(__assign({}, normalisedConfig), { onHandleEvent: function (event) {
                    ...
                    var response;
                    return __generator(this, function (_a) {
                        response = __assign(__assign({}, context), { requestInit: __assign(__assign({}, context.requestInit), { headers: __assign(__assign({}, context.requestInit.headers), { rid: Session.RECIPE_ID }) }) });
