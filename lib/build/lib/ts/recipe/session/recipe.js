                    ...
                    switch (_a.label) {
                        ...
                        case 13:
                            ...
                            if (successRedirectContext.action === "SUCCESS_OAUTH2") {
                                return [
                                    2 /*return*/,
                                    OAuth2Provider.getInstanceOrThrow().redirect(
                                        successRedirectContext,
                                        navigate,
                                        {},
                                        userContext
                            ...
                            return [
                                2 /*return*/,
                                SuperTokens.getInstanceOrThrow().redirect(
                                    successRedirectContext,
                                    navigate,
                                    {},
                                    userContext
        ...
        return {
            ...
            authReact: function (appInfo) {
                Session.instance = new Session(
                    __assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Session.RECIPE_ID })
                );
                return Session.instance;
            },
            webJS: WebJSSessionRecipe.init(
