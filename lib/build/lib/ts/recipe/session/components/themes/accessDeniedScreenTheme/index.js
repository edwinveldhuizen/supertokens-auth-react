...
var AccessDeniedScreen = function (props) {
    ...
    return (jsx("div", __assign({ "data-supertokens": "center accessDenied" }, { children: jsx("div", __assign({ "data-supertokens": "container" }, { children: jsxs("div", __assign({ "data-supertokens": "row" }, { children: [jsx(ErrorRoundIcon, {}), jsx("div", __assign({ "data-supertokens": "headerTitle" }, { children: t("ACCESS_DENIED") })), jsx("div", { "data-supertokens": "divider" }), props.error && jsxs("div", __assign({ "data-supertokens": "primaryText accessDeniedError" }, { children: [" ", props.error] })), jsxs("div", __assign({ "data-supertokens": "buttonsGroup" }, { children: [jsx(BackButton, { onClick: onBackButtonClicked }), jsx(LogoutButton, { onClick: onLogout })] }))] })) })) })));
};
...
var AccessDeniedScreenTheme = function (props) {
    ...
    return (jsx(ThemeBase, __assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.accessDeniedScreen.style] }, { children: jsx(AccessDeniedThemeWithOverride, __assign({}, props)) })));
};
