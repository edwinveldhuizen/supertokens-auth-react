...
var Multitenancy = /** @class */ (function (_super) {
    ...
    function Multitenancy(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = MultitenancyWebJS; }
    ...
    Multitenancy.getDynamicLoginMethods = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, MultitenancyWebJS.getLoginMethods(input)];
                    case 1:
    ...
    Multitenancy.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Multitenancy.instance = new Multitenancy(__assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Multitenancy.RECIPE_ID }));
