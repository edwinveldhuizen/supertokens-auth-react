...
var DynamicLoginMethodsSpinner = function () {
    ...
    return (jsx(ComponentOverrideContext.Provider, __assign({ value: recipeComponentOverrides }, { children: jsx(WithOrWithoutShadowDom, __assign({ useShadowDom: SuperTokens.getInstanceOrThrow().useShadowDom }, { children: jsx(DynamicLoginMethodsSpinnerTheme, { config: recipe.config }) })) })));
};
