...
function normaliseMultiFactorAuthFeature(config) {
    ...
    return __assign(__assign({}, normaliseRecipeModuleConfig(config)), { totpMFAScreen: __assign({ disableDefaultUI: false, blockedScreenStyle: "", setupScreenStyle: "", verificationScreenStyle: "", loadingScreenStyle: "" }, config.totpMFAScreen), override: override });
}
