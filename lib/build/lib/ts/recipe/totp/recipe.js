...
var TOTP = /** @class */ (function (_super) {
    ...
    function TOTP(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = TOTPWebJS; }
        var _this = _super.call(this, config) || this;
        _this.webJSRecipe = webJSRecipe;
        _this.recipeID = TOTP.RECIPE_ID;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        _this.getDefaultRedirectionURL = function (_context) { return __awaiter(_this, void 0, void 0, function () {
    ...
    TOTP.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                TOTP.instance = new TOTP(__assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: TOTP.RECIPE_ID }));
                return TOTP.instance;
            },
            webJS: TOTPWebJS.init(__assign(__assign({}, normalisedConfig), { override: {
