...
var CodeForm = withOverride("TOTPCodeForm", function TOTPCodeForm(props) {
    ...
    return (jsx(React__default.Fragment, { children: jsx(FormBase, { formDataSupertokens: "totp-mfa codeForm", clearError: props.clearError, onError: props.onError, formFields: [
                {
                    id: "totp",
            ...
            ], onSuccess: props.onSuccess, buttonLabel: "TOTP_CODE_CONTINUE_BUTTON", callAPI: function (formFields) { return __awaiter(_this, void 0, void 0, function () {
                var totp, response;
                var _a;
