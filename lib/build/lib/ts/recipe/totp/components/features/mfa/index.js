...
import { getQueryParams, getRedirectToPathFromURL, useOnMountAPICall, useRethrowInRender } from '../../../../../utils.js';
...
var useFeatureReducer = function () {
    return React.useReducer(function (oldState, action) {
        ...
        switch (action.type) {
            ...
            case "setBlocked":
                return __assign(__assign({}, oldState), { isBlocked: true, nextRetryAt: action.nextRetryAt, error: action.error });
            case "setError":
                return __assign(__assign({}, oldState), { loaded: true, maxAttemptCount: (_a = action.maxAttemptCount) !== null && _a !== void 0 ? _a : oldState.maxAttemptCount, currAttemptCount: (_b = action.currAttemptCount) !== null && _b !== void 0 ? _b : oldState.currAttemptCount, showAccessDenied: action.showAccessDenied, error: action.error });
            case "createDevice":
                return __assign(__assign({}, oldState), { deviceInfo: action.deviceInfo, isBlocked: false, showSecret: false, nextRetryAt: undefined, error: undefined });
            case "showSecret":
                return __assign(__assign({}, oldState), { showSecret: true });
            case "restartFlow":
                return __assign(__assign({}, oldState), { isBlocked: false, showSecret: false, nextRetryAt: undefined, error: action.error });
            default:
                return oldState;
        }
    }, {
    ...
    var onLoad = React.useCallback(function (mfaInfo) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(undefined, TOTP.RECIPE_ID, redirectToPath, userContext, navigate)];
                case 2:
                    _c.sent();
                    return [3 /*break*/, 4];
                case 3:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [4 /*yield*/, Session.getInstanceOrThrow().signOut({ userContext: userContext })];
                        case 3:
                            _a.sent();
...
var SignInUpFeature = function (props) {
    ...
    var recipeImplementation = React.useMemo(function () { return getModifiedRecipeImplementation(props.recipe.webJSRecipe, dispatch); }, [props.recipe]);
    ...
    return (jsx(ComponentOverrideContext.Provider, __assign({ value: recipeComponentOverrides }, { children: jsx(FeatureWrapper, __assign({ useShadowDom: SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsTOTP }, { children: jsxs(Fragment, { children: [props.children === undefined && (jsx(TOTPMFAThemeWrapper, __assign({}, childProps, { featureState: state, dispatch: dispatch }))), props.children &&
...
function getModifiedRecipeImplementation(originalImpl, dispatch) {
    var _this = this;
    return __assign(__assign({}, originalImpl), { createDevice: function (input) { return __awaiter(_this, void 0, void 0, function () {
            var res, deviceInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        }); }, verifyCode: function (input) { return __awaiter(_this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        }); }, verifyDevice: function (input) { return __awaiter(_this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        }); }, removeDevice: function (input) { return __awaiter(_this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
