...
import { isTest, getDefaultRedirectionURLForPath, getCurrentNormalisedUrlPathWithQueryParamsAndFragments, appendQueryParamsToURL, getRedirectToPathFromURL, getTenantIdFromQueryParams } from '../../utils.js';
...
var MultiFactorAuth = /** @class */ (function (_super) {
    ...
    function MultiFactorAuth(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = MultiFactorAuthWebJS; }
        var _this = _super.call(this, config) || this;
        _this.webJSRecipe = webJSRecipe;
        _this.recipeID = MultiFactorAuth.RECIPE_ID;
        _this.secondaryFactors = [];
        _this.getDefaultRedirectionURL = function (context, userContext) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                if (context.action === "FACTOR_CHOOSER") {
                    nParam = context.nextFactorOptions && context.nextFactorOptions.length > 0
                        ...
                        : undefined;
                    return [2 /*return*/, getDefaultRedirectionURLForPath(this.config, DEFAULT_FACTOR_CHOOSER_PATH, context, {
                            n: nParam,
                    ...
                    if (redirectInfo !== undefined) {
                        return [2 /*return*/, getDefaultRedirectionURLForPath(this.config, redirectInfo.path, context, {
    ...
    MultiFactorAuth.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                MultiFactorAuth.instance = new MultiFactorAuth(__assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: MultiFactorAuth.RECIPE_ID }));
                return MultiFactorAuth.instance;
            },
            webJS: MultiFactorAuthWebJS.init(__assign(__assign({}, normalisedConfig), { override: {
    ...
    MultiFactorAuth.prototype.addMFAFactors = function (secondaryFactors) {
        this.secondaryFactors = __spreadArray(__spreadArray([], this.secondaryFactors.filter(function (factor) {
    ...
    MultiFactorAuth.MultiFactorAuthClaim = new MultiFactorAuthClaimClass(function () { return MultiFactorAuth.getInstanceOrThrow(); }, function (context, userContext) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, this.getInstanceOrThrow().getRedirectUrl(__assign(__assign({}, context), { tenantIdFromQueryParams: getTenantIdFromQueryParams() }), userContext)];
