...
var FactorChooser = function (props) {
    ...
    var navigateToFactor = useCallback(
        function (factorId) {
    ...
    var onBackButtonClicked = useCallback(
        function () {
                            ...
                            children: jsxs(Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsx(FactorChooserThemeWrapper, __assign({}, childProps)),
                                    props.children &&
