...
var FactorChooserHeader = withOverride("MFAFactorChooserHeader", function MFAFactorChooserHeader(props) {
    ...
    return (jsx("div", __assign({ "data-supertokens": "row factorChooserHeader" }, { children: jsxs("div", __assign({ "data-supertokens": "headerTitle withBackButton" }, { children: [props.showBackButton ? (jsx(BackButton, { onClick: props.onBackButtonClicked })) : (jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })), t("MULTI_FACTOR_CHOOSER_HEADER_TITLE"), jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] })) })));
});
