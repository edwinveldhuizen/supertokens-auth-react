...
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = ThirdpartyWebJS; }
        var _this = this;
    ...
    ThirdParty.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                ThirdParty.instance = new ThirdParty(__assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID }));
                return ThirdParty.instance;
            },
            webJS: ThirdpartyWebJS.init(__assign(__assign({}, normalisedConfig), { override: {
