...
function normaliseThirdPartyConfig(config) {
    ...
    return __assign(__assign({}, normaliseAuthRecipe(config)), { signInAndUpFeature: signInAndUpFeature, oAuthCallbackScreen: oAuthCallbackScreen, override: override });
}
...
function redirectToThirdPartyLogin(input) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Multitenancy.getInstanceOrThrow().getCurrentDynamicLoginMethods({
                        userContext: input.userContext,
                    })];
                case 1:
                    loginMethods = _a.sent();
                    tenantProviders = (loginMethods === null || loginMethods === void 0 ? void 0 : loginMethods.firstFactors.includes(FactorIds.THIRDPARTY))
...
var mergeProviders = function (_a) {
    ...
    var _loop_1 = function (tenantProvider) {
        ...
        if (provider !== undefined) {
            providers.push(Custom.init(__assign(__assign({}, provider.config), { id: tenantProvider.id, name: tenantProvider.name, buttonComponent: provider.getButton(tenantProvider.name) })));
        }
        else {
...
export { matchRecipeIdUsingState, mergeProviders, normaliseSignInAndUpFeature, normaliseThirdPartyConfig, redirectToThirdPartyLogin };
