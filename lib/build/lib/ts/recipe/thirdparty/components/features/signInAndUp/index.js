...
var SignInAndUpFeature = function (props) {
    ...
    return (jsxs(Fragment, { children: [props.children === undefined && jsx(SignInAndUpThemeWrapper, __assign({}, themeProps)), props.children &&
...
var SignInAndUpFeatureWrapper = function (props) {
    ...
    return (jsx(AuthComponentWrapper, __assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsx(SignInAndUpFeature, __assign({}, props)) })));
};
