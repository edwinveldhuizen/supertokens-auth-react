...
var SignInAndUpCallback = function (props) {
    ...
    var handleVerifyResponse = useCallback(function (_a) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(__assign(__assign({}, ctx), { action: "SUCCESS_OAUTH2", frontendRedirectTo: frontendRedirectTo }), props.recipe.recipeID, redirectToPath, userContext, props.navigate)];
                    case 7:
                        e_1 = _c.sent();
                        rethrowInRender(e_1);
                        return [3 /*break*/, 8];
                    case 8: return [3 /*break*/, 10];
                    case 9: return [2 /*return*/, Session.getInstanceOrThrow()
                            .validateGlobalClaimsAndHandleSuccessRedirection(__assign(__assign({}, ctx), { action: "SUCCESS" }), props.recipe.recipeID, redirectToPath, userContext, props.navigate)
    ...
    var handleError = useCallback(function (err) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!("status" in err && err.status === Session.getInstanceOrThrow().config.invalidClaimStatusCode)) return [3 /*break*/, 5];
    ...
    return (jsx(ComponentOverrideContext.Provider, __assign({ value: recipeComponentOverrides }, { children: jsx(FeatureWrapper, __assign({ useShadowDom: SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsThirdParty }, { children: jsxs(Fragment, { children: [props.children === undefined && jsx(SignInAndUpCallbackTheme, { config: props.recipe.config }), props.children] }) })) })));
};
