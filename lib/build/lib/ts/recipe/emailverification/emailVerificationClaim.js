    ...
    function EmailVerificationClaimClass(getRecipeImpl, onFailureRedirection) {
        ...
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return __assign(__assign({}, validator.apply(void 0, args)), { onFailureRedirection: function (args) {
                        ...
                        if (recipe.config.mode === "REQUIRED") {
                            return recipe.getRedirectUrl({ action: "VERIFY_EMAIL", tenantIdFromQueryParams: getTenantIdFromQueryParams() }, args.userContext);
                        }
                        return undefined;
