...
var EmailVerification = function (props) {
    ...
    var redirectToAuthWithHistory = useCallback(
        function () {
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, redirectToAuth({ redirectBack: false, navigate: props.navigate })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    var modifiedRecipeImplementation = useMemo(
        function () {
    ...
    var fetchIsEmailVerified = useCallback(
        function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var token;
                var _a;
    ...
    var checkIsEmailVerified = useCallback(
        function (isVerified) {
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (isVerified) {
                            ...
                            children: jsxs(Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsx(EmailVerificationThemeWrapper, __assign({}, childProps)),
                                    props.children &&
