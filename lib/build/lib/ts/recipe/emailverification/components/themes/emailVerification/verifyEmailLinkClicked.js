...
var EmailVerificationVerifyEmailLinkClicked = function (props) {
    ...
    var _c = useState(false), verifyLoading = _c[0], setVerifyLoading = _c[1];
    var verifyEmailOnMount = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var handleVerifyResp = useCallback(function (response) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    if (status === "INTERACTION_REQUIRED") {
        return (jsx("div", __assign({ "data-supertokens": "container" }, { children: jsxs("div", __assign({ "data-supertokens": "row noFormRow" }, { children: [jsx("div", __assign({ "data-supertokens": "headerTitle" }, { children: t("EMAIL_VERIFICATION_LINK_CLICKED_HEADER") })), jsx("div", __assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("EMAIL_VERIFICATION_LINK_CLICKED_DESC") })), jsx(Button, { isLoading: verifyLoading, onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                            var resp, err_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
    ...
    if (status === "SUCCESSFUL") {
        return (jsx("div", __assign({ "data-supertokens": "container" }, { children: jsxs("div", __assign({ "data-supertokens": "row noFormRow" }, { children: [jsx(CheckedRoundIcon, {}), jsx("div", __assign({ "data-supertokens": "headerTitle headerTinyTitle" }, { children: t("EMAIL_VERIFICATION_SUCCESS") })), jsx("div", __assign({ "data-supertokens": "emailVerificationButtonWrapper" }, { children: jsx(Button, { isLoading: false, onClick: onSuccess, type: "button", label: "EMAIL_VERIFICATION_CONTINUE_BTN" }) }))] })) })));
    }
    if (status === "INVALID") {
        return (jsx("div", __assign({ "data-supertokens": "container" }, { children: jsxs("div", __assign({ "data-supertokens": "row noFormRow" }, { children: [jsx("div", __assign({ "data-supertokens": "headerTitle headerTinyTitle" }, { children: t("EMAIL_VERIFICATION_EXPIRED") })), jsxs("div", __assign({ onClick: onTokenInvalidRedirect, "data-supertokens": "secondaryText secondaryLinkWithArrow" }, { children: [t("EMAIL_VERIFICATION_CONTINUE_LINK"), " ", jsx(ArrowRightIcon, { color: "rgb(var(--palette-textPrimary))" })] }))] })) })));
    }
    return (jsx("div", __assign({ "data-supertokens": "container" }, { children: jsxs("div", __assign({ "data-supertokens": "row noFormRow" }, { children: [jsxs("div", __assign({ "data-supertokens": "headerTitle error" }, { children: [jsx(ErrorLargeIcon, {}), t("EMAIL_VERIFICATION_ERROR_TITLE")] })), jsx("div", __assign({ "data-supertokens": "primaryText" }, { children: t(errorMessage === undefined ? "EMAIL_VERIFICATION_ERROR_DESC" : errorMessage) }))] })) })));
};
var VerifyEmailLinkClicked = withOverride("EmailVerificationVerifyEmailLinkClicked", EmailVerificationVerifyEmailLinkClicked);
