...
var EmailVerificationSendVerifyEmail = function (props) {
    ...
    var sendVerificationEmail = useCallback(function () {
        return props.recipeImplementation.sendVerificationEmail({
            userContext: userContext,
        });
    }, [props.config, props.recipeImplementation]);
    var checkSendResponse = useCallback(function (response) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleSendError = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    return (jsx("div", __assign({ "data-supertokens": "container" }, { children: jsxs("div", __assign({ "data-supertokens": "row" }, { children: [status === "ERROR" && (jsx(GeneralError, { error: errorMessage === undefined ? "SOMETHING_WENT_WRONG_ERROR" : errorMessage })), status === "EMAIL_RESENT" && (jsx("div", __assign({ "data-supertokens": "generalSuccess" }, { children: t("EMAIL_VERIFICATION_RESEND_SUCCESS") }))), jsx("div", __assign({ "data-supertokens": "sendVerifyEmailIcon" }, { children: jsx(EmailLargeIcon, {}) })), jsx("div", __assign({ "data-supertokens": "headerTitle headerTinyTitle" }, { children: t("EMAIL_VERIFICATION_SEND_TITLE") })), jsx("div", { "data-supertokens": "divider" }), jsxs("div", __assign({ "data-supertokens": "primaryText sendVerifyEmailText" }, { children: [t("EMAIL_VERIFICATION_SEND_DESC_START"), jsx("strong", { children: t("EMAIL_VERIFICATION_SEND_DESC_STRONG") }), t("EMAIL_VERIFICATION_SEND_DESC_END")] })), jsxs("div", __assign({ "data-supertokens": "buttonWithArrow", onClick: logout }, { children: [jsx("div", __assign({ "data-supertokens": "secondaryText secondaryLinkWithRightArrow" }, { children: t("EMAIL_VERIFICATION_LOGOUT") })), jsx(ArrowRightIcon, { color: "rgb(var(--palette-textGray))" })] })), status !== "EMAIL_RESENT" && (jsx("div", __assign({ "data-supertokens": "link sendVerifyEmailResend", onClick: resendEmail }, { children: t("EMAIL_VERIFICATION_RESEND_BTN") })))] })) })));
};
