...
var EmailVerification = /** @class */ (function (_super) {
    ...
    function EmailVerification(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = EmailVerificationWebJS; }
        ...
        _this.getDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (context.action === "VERIFY_EMAIL") {
                    return [2 /*return*/, getDefaultRedirectionURLForPath(this.config, DEFAULT_VERIFY_EMAIL_PATH, context)];
                }
                else {
                    return [2 /*return*/, "/"];
                }
    ...
    EmailVerification.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                EmailVerification.instance = new EmailVerification(__assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: EmailVerification.RECIPE_ID }));
                return EmailVerification.instance;
            },
            webJS: EmailVerificationWebJS.init(__assign(__assign({}, normalisedConfig), { override: {
