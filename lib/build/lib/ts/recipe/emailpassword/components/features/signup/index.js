...
function useChildProps(recipe, onAuthSuccess, error, onError, clearError, userContext, navigate) {
    ...
    var recipeImplementation = useMemo(function () { return recipe && getModifiedRecipeImplementation(recipe.webJSRecipe); }, [recipe]);
    var rethrowInRender = useRethrowInRender();
    var onSignUpSuccess = useCallback(function (result) { return __awaiter(_this, void 0, void 0, function () {
...
var SignUpFeature = function (props) {
    ...
    return (jsx(AuthComponentWrapper, __assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxs(Fragment, { children: [props.children === undefined && jsx(SignUpTheme, __assign({}, childProps)), props.children &&
