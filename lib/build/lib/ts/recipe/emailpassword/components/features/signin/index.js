...
function useChildProps(recipe, onAuthSuccess, error, onError, clearError, userContext, navigate) {
    ...
    var recipeImplementation = useMemo(
        function () {
            return getModifiedRecipeImplementation(recipe.webJSRecipe);
        },
        [recipe]
    );
    var rethrowInRender = useRethrowInRender();
    var t = useTranslation();
    var onSignInSuccess = useCallback(
        function () {
                    ...
                    : __assign(__assign({}, f), {
                          labelComponent: jsxs(
                              ...
                              __assign(
                                  ...
                                  {
                                      children: [
                                          jsx(Label, { value: f.label, "data-supertokens": "passwordInputLabel" }),
                                          jsx(
                                              "a",
                                              __assign(
                                                  {
        ...
        __assign(
            { recipeComponentOverrides: recipeComponentOverrides },
            {
                children: jsxs(Fragment, {
                    children: [
                        props.children === undefined && jsx(SignInTheme, __assign({}, childProps)),
                        props.children &&
