...
var ResetPasswordUsingToken = function (props) {
    ...
    return (jsx(ComponentOverrideContext.Provider, __assign({ value: recipeComponentOverrides }, { children: jsx(FeatureWrapper, __assign({ useShadowDom: SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsEmailPassword }, { children: jsxs(Fragment, { children: [props.children === undefined && jsx(ResetPasswordUsingTokenThemeWrapper, __assign({}, childProps)), props.children &&
