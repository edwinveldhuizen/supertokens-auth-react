...
function InputComponentWrapper(props) {
    ...
    var useCallbackOnInputFocus = useCallback(
        function (value) {
            onInputFocus({
                id: field.id,
                value: value,
    ...
    var useCallbackOnInputBlur = useCallback(
        function (value) {
            onInputBlur({
                id: field.id,
                value: value,
    ...
    var useCallbackOnInputChange = useCallback(
        function (value) {
            onInputChange({
                id: field.id,
                value: value,
...
var FormBase = function (props) {
    ...
    var _b = useState(false),
        isLoading = _b[0],
        setIsLoading = _b[1];
    var updateFieldState = useCallback(
        function (id, update) {
                        ...
                        case 2:
                            ...
                            if (generalError !== undefined) {
                                ...
                                if (result.status === "FIELD_ERROR") {
                                    ...
                                    setFieldStates(function (os) {
                                        return os.map(function (fs) {
                                            return __assign(__assign({}, fs), { error: getErrorMessage_1(fs) });
                                        });
                                    });
                                }
                            }
                                                ...
                                                { hasError: fstate.error !== undefined },
                                                {
                                                    children: jsxs(Fragment, {
                                                        children: [
                                                            ...
                                                            fstate.error && jsx(InputError, { error: fstate.error }),
                                                        ],
                                                    }),
                                                }
                                            ),
