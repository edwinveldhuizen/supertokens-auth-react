...
var Input = function (_a) {
    ...
    return (jsx("div", __assign({ "data-supertokens": "inputContainer" }, { children: jsxs("div", __assign({ "data-supertokens": ["inputWrapper", hasError ? "inputError" : ""].join(" ") }, { children: [jsx("input", { autoFocus: autofocus, autoComplete: autoComplete, "data-supertokens": "input input-".concat(name), className: "supertokens-input", onFocus: handleFocus, onBlur: handleBlur, type: inputType, name: name, placeholder: t(placeholder), onChange: handleChange, value: value }), hasError === true && (jsx("div", __assign({ "data-supertokens": "inputAdornment inputAdornmentError" }, { children: jsx(ErrorIcon, {}) }))), validated === true && hasError === false && (jsx("div", __assign({ "data-supertokens": "inputAdornment inputAdornmentSuccess" }, { children: jsx(CheckedIcon, {}) }))), type === "password" && value.length > 0 && (jsx("div", __assign({ onClick: function () { return setShowPassword(showPassword === false); }, "data-supertokens": "inputAdornment showPassword" }, { children: jsx(ShowPasswordIcon, { showPassword: showPassword }) })))] })) })));
};
