...
function ResetPasswordUsingTokenThemeWrapper(props) {
    ...
    return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(ThemeBase, __assign({ userStyles: [rootStyle, props.config.recipeRootStyle, userStyles] }, { children: jsx(ResetPasswordUsingTokenTheme, __assign({}, props)) })) })));
}
