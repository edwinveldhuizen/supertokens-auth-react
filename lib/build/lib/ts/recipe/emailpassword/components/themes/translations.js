...
import { defaultTranslationsEmailVerification } from "../../../emailverification/components/themes/translations.js";

var defaultTranslationsEmailPassword = {
    en: __assign(__assign(__assign({}, defaultTranslationsCommon.en), defaultTranslationsEmailVerification.en), {
...
export { defaultTranslationsEmailPassword };
