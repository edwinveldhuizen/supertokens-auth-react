    ...
    for (var i = 0; i < userFormFields.length; i++) {
        ...
        if (isNewField) {
            mergedFormFields.push(
                __assign({ optional: false, placeholder: userField.label, validate: defaultValidate }, userField)
            );
        }
    }
...
export {
    ...
    mergeFormFields,
    normaliseEmailPasswordConfig,
    normaliseResetPasswordUsingTokenFeature,
    normaliseSignInAndUpFeature,
    normaliseSignInFormFeatureConfig,
    normaliseSignUpFormFeatureConfig,
};
