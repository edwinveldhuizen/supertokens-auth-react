...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    ...
    function ThirdPartyPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath("/callback/:id"));
            features[normalisedFullPath.getAsStringDangerous()] = {
                matches: function () { return matchRecipeIdUsingState(_this.recipeInstance, {}); },
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "signinupcallback") {
                return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(SessionAuth, __assign({ requireAuth: false, doRedirection: false }, { children: jsx(SignInAndUpCallback$1, __assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })) })));
            }
            else {
    ...
    ThirdPartyPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        return [
            {
                component: function (props) { return (jsx(SignInAndUpFeatureWrapper, __assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: useContext }), "thirdparty-signinup")); },
                displayOrder: 1,
