    ...
    function EmailVerificationPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath(DEFAULT_VERIFY_EMAIL_PATH));
        ...
        _, props, useComponentOverrides) {
            if (useComponentOverrides === void 0) { useComponentOverrides = useContext; }
            return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(SessionAuth, __assign({ requireAuth: false, overrideGlobalClaimValidators: function () { return []; } }, { children: jsx(UserContextContext.Consumer, { children: function (value) {
                            return (jsx(EmailVerification$2, __assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, __assign(__assign({}, props), { 
