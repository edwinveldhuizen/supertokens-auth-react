...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.createDevice = function (input) {
        return TOTP.getInstanceOrThrow().webJSRecipe.createDevice(
    ...
    Wrapper.verifyCode = function (input) {
        return TOTP.getInstanceOrThrow().webJSRecipe.verifyCode(
            __assign(__assign({}, input), {
                userContext: getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
            })
        );
    ...
    Wrapper.verifyDevice = function (input) {
        return TOTP.getInstanceOrThrow().webJSRecipe.verifyDevice(
            __assign(__assign({}, input), {
                userContext: getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
            })
        );
    ...
    Wrapper.removeDevice = function (input) {
        return TOTP.getInstanceOrThrow().webJSRecipe.removeDevice(
            __assign(__assign({}, input), {
                userContext: getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
            })
        );
    ...
    Wrapper.listDevices = function (input) {
        return TOTP.getInstanceOrThrow().webJSRecipe.listDevices(
            __assign(__assign({}, input), {
                userContext: getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
            })
        );
