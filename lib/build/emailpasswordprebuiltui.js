    ...
    function EmailPasswordPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.resetPasswordUsingTokenFeature.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath(DEFAULT_RESET_PASSWORD_PATH));
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "resetpassword") {
                return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(ResetPasswordUsingToken$1, __assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            else {
        ...
        return [
            {
                ...
                displayOrder: 2,
                type: "SIGN_UP",
                component: function (props) { return (jsx(SignUpFeature, __assign({ recipe: _this.recipeInstance, useComponentOverrides: useContext }, props), "emailpassword-sign-up")); },
            },
            {
                factorIds: [FactorIds.EMAILPASSWORD],
                displayOrder: 2,
                type: "SIGN_IN",
                component: function (props) { return (jsx(SignInFeature, __assign({ recipe: _this.recipeInstance, useComponentOverrides: useContext }, props), "emailpassword-sign-in")); },
            },
        ];
    };
    // For tests
...
export { EmailPasswordPreBuiltUI, ResetPasswordUsingToken, ResetPasswordUsingTokenThemeWrapper as ResetPasswordUsingTokenTheme };
