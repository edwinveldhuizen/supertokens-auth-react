    ...
    function PasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.linkClickedScreenFeature.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath("/verify"));
            ...
            if (_this.recipeInstance.config.mfaFeature.disableDefaultUI !== true) {
                var normalisedFullPathPhone = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath("/mfa/otp-phone"));
                ...
                var normalisedFullPathEmail = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath("/mfa/otp-email"));
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "linkClickedScreen") {
                return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(SessionAuth, __assign({ requireAuth: false, doRedirection: false }, { children: jsx(LinkClickedScreen, __assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })) })));
            }
            if (componentName === "otp-email") {
                return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(SessionAuth, __assign({ overrideGlobalClaimValidators: function () { return []; } }, { children: jsx(MFAFeature, __assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides, contactMethod: "EMAIL", flowType: "USER_INPUT_CODE" }, props)) })) })));
            }
            if (componentName === "otp-phone") {
                return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(SessionAuth, __assign({ overrideGlobalClaimValidators: function () { return []; } }, { children: jsx(MFAFeature, __assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides, contactMethod: "PHONE", flowType: "USER_INPUT_CODE" }, props)) })) })));
            }
    ...
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        var res = __spreadArray(__spreadArray([
            {
                ...
                preloadInfoAndRunChecks: function (firstFactors, userContext) {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                case 0: return [4 /*yield*/, Passwordless.getInstanceOrThrow().webJSRecipe.getLoginAttemptInfo({
                                ...
                                case 1:
                                    ...
                                    if (!(loginAttemptInfo.contactMethod === "PHONE" &&
                                        ...
                                        !firstFactors.includes(FactorIds.LINK_PHONE))) return [3 /*break*/, 3];
                                    return [4 /*yield*/, ((_b = Passwordless.getInstanceOrThrow().webJSRecipe) === null || _b === void 0 ? void 0 : _b.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 2:
                                    _e.sent();
                                ...
                                case 3:
                                    if (!(loginAttemptInfo.contactMethod === "EMAIL" &&
                                        ...
                                        !firstFactors.includes(FactorIds.LINK_EMAIL))) return [3 /*break*/, 5];
                                    return [4 /*yield*/, ((_c = Passwordless.getInstanceOrThrow().webJSRecipe) === null || _c === void 0 ? void 0 : _c.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 4:
                                    _e.sent();
                                    loginAttemptInfo = undefined;
                                    return [3 /*break*/, 7];
                                case 5:
                                    if (!!checkAdditionalLoginAttemptInfoProperties(loginAttemptInfo)) return [3 /*break*/, 7];
                                    ...
                                    return [4 /*yield*/, ((_d = Passwordless.getInstanceOrThrow().webJSRecipe) === null || _d === void 0 ? void 0 : _d.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 6:
                                    // If these properties are not set, it means that the user likely started logging in
                                    // using a custom UI and then switched to the pre-built UI. In that case, we should clear
                                    // the login attempt info so that the user is prompted to login again, since the pre-built UI
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = __rest(_b, ["preloadInfo"]);
                    return (jsx(LinkSentFeature, __assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: useContext, loginAttemptInfo: preloadInfo }), "linkSentFullPage"));
                },
            },
            {
                type: "FULL_PAGE",
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = __rest(_b, ["preloadInfo"]);
                    return (jsx(UserInputCodeFeature, __assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: useContext, loginAttemptInfo: preloadInfo }), "userInputCodeFullPage"));
                },
            }
            ...
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (createElement(SignInUpFeature, __assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: useContext, factorIds: factors }))); },
        }); }), true), factorCombos.map(function (factors) { return ({
            type: "SIGN_UP",
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (jsx(ContinueWithPasswordlessFeature, __assign({}, props, { recipe: _this.recipeInstance, factorIds: factors, useComponentOverrides: useContext }), factors.join("|"))); },
        }); }), true);
        ...
        try {
            ...
            res.push.apply(res, factorCombos
                .map(function (combo) { return __spreadArray([FactorIds.EMAILPASSWORD], combo, true); })
                .map(function (factors) { return ({
                type: "SIGN_IN",
                factorIds: factors,
                displayOrder: 3,
                component: function (props) { return (createElement(SignInUpEPComboFeature, __assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: useContext, factorIds: factors }))); },
            }); }));
        }
        catch (_b) {
...
function getAllChoices(choices) {
    ...
    return __spreadArray(__spreadArray([], subChoices, true), subChoices.map(function (a) { return __spreadArray([choices[0]], a, true); }), true);
}
