...
var UI = /** @class */ (function () {
        ...
        if (UI.reactRouterDomIsV6) {
            if (UI.reactRouterDom === undefined) {
                ...
                var useNavigateHookForRRDV6 = function () {
                    ...
                    var _a = React__default.useState(undefined), to = _a[0], setTo = _a[1];
    ...
    UI.canHandleRoute = function (preBuiltUiClassList) {
        ...
        return (RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList(getCurrentNormalisedUrlPath(), recipeList, true) !== undefined);
    };
    UI.getRoutingComponent = function (preBuiltUiClassList) {
        var recipeList = preBuiltUiClassList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); });
        return (jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: UI.getReactRouterDomWithCustomHistory, path: getCurrentNormalisedUrlPath().getAsStringDangerous(), preBuiltUIList: recipeList }));
    };
    UI.getReactRouterDomWithCustomHistory = function () {
        return UI.reactRouterDom;
    };
    UI.AuthPage = function (props) { return (jsx(AuthPageWrapper, __assign({}, props, { preBuiltUIList: props.preBuiltUIList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); }) }))); };
...
export { AuthPage, AuthPageComponentList, AuthPageFooter, AuthPageHeader, AuthPageTheme, Provider as AuthRecipeComponentsOverrideContextProvider, canHandleRoute, UI as default, getRoutingComponent, getSuperTokensRoutesForReactRouterDom };
