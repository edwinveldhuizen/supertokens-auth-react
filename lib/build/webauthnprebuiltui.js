...
import { SignInUpFeatureFullPage, SignUpWithPasskeyFeature } from './lib/ts/recipe/webauthn/components/features/signUp/index.js';
import { defaultTranslationsWebauthn } from './lib/ts/recipe/webauthn/components/themes/translations.js';
import { DEFAULT_WEBAUTHN_RECOVERY_PATH, DEFAULT_WEBAUTHN_SEND_RECOVERY_EMAIL_PATH } from './lib/ts/recipe/webauthn/constants.js';
    ...
    function WebauthnPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.disableDefaultUI !== true &&
                ...
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath(DEFAULT_WEBAUTHN_RECOVERY_PATH));
                ...
                var normalisedFullPathForRecoveryThroughEmail = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath(DEFAULT_WEBAUTHN_SEND_RECOVERY_EMAIL_PATH));
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "webauthn-recover-account") {
                return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(RecoverAccountUsingToken, __assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            else if (componentName === "webauthn-send-recovery-email") {
                return (jsx(UserContextWrapper, __assign({ userContext: props.userContext }, { children: jsx(SendRecoveryEmailForm, __assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
                ...
                preloadInfoAndRunChecks: function (firstFactors, _, isSignUp) {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, {
                                    shouldDisplay: isSignUp && firstFactors.length === 1 && firstFactors.includes(FactorIds.WEBAUTHN),
                                    preloadInfo: {},
                                }];
                        });
                    });
                },
                component: function (props) { return (jsx(SignInUpFeatureFullPage, __assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: useContext, factorIds: [FactorIds.WEBAUTHN] }), "webauthnSignUpFullPage")); },
            },
            {
                type: "SIGN_UP",
                factorIds: [FactorIds.WEBAUTHN],
                displayOrder: 4,
                component: function (props) { return (jsx(SignUpWithPasskeyFeature, __assign({}, props, { recipe: _this.recipeInstance, factorIds: [FactorIds.WEBAUTHN], useComponentOverrides: useContext }), "webauthn-sign-up")); },
            },
            {
                type: "SIGN_IN",
                factorIds: [FactorIds.WEBAUTHN],
                displayOrder: 4,
                component: function (props) { return (jsx(SignInWithPasskeyFeature, __assign({}, props, { recipe: _this.recipeInstance, factorIds: [FactorIds.WEBAUTHN], useComponentOverrides: useContext }), "webauthn-sign-in")); },
            },
        ];
    };
    // For tests
