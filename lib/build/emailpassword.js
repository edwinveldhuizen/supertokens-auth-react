    ...
    Wrapper.signOut = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    EmailPassword.getInstanceOrThrow().signOut({
    ...
    Wrapper.submitNewPassword = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    EmailPassword.getInstanceOrThrow().webJSRecipe.submitNewPassword(
    ...
    Wrapper.sendPasswordResetEmail = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    EmailPassword.getInstanceOrThrow().webJSRecipe.sendPasswordResetEmail(
                        __assign(__assign({}, input), { userContext: getNormalisedUserContext(input.userContext) })
                    ),
                ];
            });
    ...
    Wrapper.signUp = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    EmailPassword.getInstanceOrThrow().webJSRecipe.signUp(
                        __assign(__assign({}, input), { userContext: getNormalisedUserContext(input.userContext) })
                    ),
                ];
            });
